...
_GAUZES_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 3019,  # num of samples in images/training
        'val': 984,  # num of samples in images/validation
    },
    num_classes=2,
    ignore_label=0,
)
